...
<div class="row">
    ...
    @if(!$isEdit)
        ...
        <div class="form-group col-sm-6 d-none doctor-department">
            {{ Form::label('doctor_department_id',__('messages.doctor_department.doctor_department').':') }}<span
                class="text-danger">*</span>
            {{ Form::select('doctor_department_id', $doctorDepartments, null, ['class' => 'form-control', 'id' => 'doctorDepartment','placeholder' => 'Select Doctor Department']) }}
        </div>
    @endif
