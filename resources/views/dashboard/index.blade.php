                    ...
                    <a href="{{ route('invoices.index') }}">
                        <div class="card card-1 text-white h-100">
                            <div class="card-body card-1">
                                ...
                                <h3 class="amount-position">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['invoiceAmount']) : convertCurrency($data['invoiceAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('bills.index') }}">
                        <div class="card text-white card-2 h-100">
                            <div class="card-body card-2">
                                ...
                                <h3 class="amount-position">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['billAmount']) : convertCurrency($data['billAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('payments.index') }}">
                        <div class="card text-white card-3 h-100">
                            <div class="card-body card-3">
                                ...
                                <h3 class="amount-position">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['paymentAmount']) : convertCurrency($data['paymentAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('advanced-payments.index') }}">
                        <div class="card text-white card-4 h-100">
                            <div class="card-body card-4">
                                ...
                                <h3 class="amount-position">{{getCurrencySymbol()}} {{ getSettingValue('current_currency') === 'inr' ? formatCurrency($data['advancePaymentAmount']) : convertCurrency($data['advancePaymentAmount']) }}
                                </h3>
                            </div>
                        </div>
                    </a>
